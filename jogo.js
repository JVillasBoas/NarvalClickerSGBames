...
function roupas() {
    ...
    if (posicao_vetor[posicao] == "narval") {
        document.getElementById("narval-id").innerHTML = '<img id="narval" src="Imagens/narval.png" draggable="false"/>';
        ...
        document.getElementById("narval-id").innerHTML = '<img id="narval-roxo" src="Imagens/narval-roxo.png" draggable="false"/>';
        botao_narval = document.getElementById("narval-roxo");
        botao_narval.addEventListener("click", click);
        botao_narval.addEventListener("click", clicks_total);
    } else if (posicao_vetor[posicao] == "narval-3d") {
        document.getElementById("narval-id").innerHTML = '<img id="narval-3d" src="Imagens/narval-3d.png" draggable="false"/>';
        botao_narval = document.getElementById("narval-3d");
        botao_narval.addEventListener("click", click);
        botao_narval.addEventListener("click", clicks_total);
    } else if (posicao_vetor[posicao] == "narval-prof") {
        document.getElementById("narval-id").innerHTML = '<img id="narval-prof" src="Imagens/narval-prof.png" draggable="false"/>';
...
function conquista_geleira() {
    if (narvs_total >= 50000 && igual3 == 0) {
        document.getElementById("geleira").innerHTML = '<img id="geleira-id" class="conquistas" src="Imagens/geleira_conquista-removebg-preview.png" alt=""></img>';
...
function conquista_dente() {
    if (narvs >= 10000 && igual == 0) {
        document.getElementById("dente").innerHTML = '<img id="dente-id" class="conquistas" src="Imagens/dente_conquista-removebg-preview.png" alt=""></img>';
...
function conquista_calice() {
    if (total_clicks == 1000) {
        document.getElementById("calice").innerHTML = '<img id="calice-id" class="conquistas" src="Imagens/calice_conquista-removebg-preview.png" alt=""></img>';
...
function conquista_estrela() {
    if (upgrades_nivel == 60 && igual2 == 0) {
        document.getElementById("estrela").innerHTML = '<img id="estrela-id" class="conquistas" src="Imagens/estrela_conquista-removebg-preview.png" alt=""></img>';
